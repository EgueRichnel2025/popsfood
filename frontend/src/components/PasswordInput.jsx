  ...
  return (
    <div className="relative">
      <input
        ...
        value={value}
        onChange={onChange}
        className={`w-full border border-pop-dark/10 rounded-lg px-3 py-2 pr-10 text-sm ${className}`}
      />
      <button
        type="button"
        onClick={() => setVisible((v) => !v)}
        className="absolute right-3 top-1/2 -translate-y-1/2 text-pop-dark/40 hover:text-pop-dark/70"
        tabIndex={-1}
